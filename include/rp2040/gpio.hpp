...
namespace RP2040 {
  ...
  public:
    ...
    bool get_output() const { return apply_override(m_output_override, current_signal().get_output()); }
    bool get_output_enable() const { return apply_override(m_oe_override, current_signal().get_oe()); }
    bool get_input() const { return apply_override(m_input_override, m_pad.digital_read()); }
