...
#include "arch/arm/armv6m/opcodes.hpp"
...
PortState ARMv6MCore::PPB::read_word(uint32_t addr, uint32_t &out){
  ...
  switch(addr) {
    case 0xE000E010: // SYST_CSR
      out = m_core.systick().CSR();
      break;
    case 0xE000E014: // SYST_RVR
      out = m_core.systick().RVR();
      break;
    case 0xE000E018: // SYST_CVR
      out = m_core.systick().CVR();
      break;
    case 0xE000E01C: // SYST_CALIB
      out = m_core.systick().CALIB();
      break;
